...
namespace 入梦工具箱
{
    public partial class Form1 : Form
    {
        ...
        public Form1()
        {
            ...
            //下面兩行為控件隨DPI自動縮放
            scale = GetDPIScale(this); // 不要寫float scale = GetDPIScale(this); 直接給成員變數賦值不要再寫 float
            this.Size = new Size((int)(952 * scale),(int)(603 * scale));  //this.Size = new Size(952, 603); 
        ...
        private void 滑块条1_位置(object sender, EventArgs e)
        {
            ...
            listView1.Size = new Size((int)(767 * scale), (int)(483 * scale));//new Size(767, 483);
            listView1.Location = new Point((int)(6 * scale), (int)(130 * scale)); //new Point(6, 130);
            listView1.BackColor = Color.White;
            listView2.Size = new Size((int)(767 * scale), (int)(483 * scale)); //new Size(767, 483);
            listView2.Location = new Point((int)(6 * scale), (int)(130 * scale)); //new Point(6, 130);
            listView2.BackColor = Color.White;
            listView3.Size = new Size((int)(767 * scale), (int)(483 * scale)); //new Size(767, 483);
            listView3.Location = new Point((int)(6 * scale), (int)(130 * scale)); //new Point(6, 130);
            listView3.BackColor = Color.White;
            listView4.Size = new Size((int)(767 * scale), (int)(483 * scale)); //new Size(767, 483);
            listView4.Location = new Point((int)(6 * scale), (int)(130 * scale)); //new Point(6, 130);
            listView4.BackColor = Color.White;
            listView5.Size = new Size((int)(767 * scale), (int)(483 * scale)); //new Size(767, 483);
            listView5.Location = new Point((int)(6 * scale), (int)(130 * scale)); //new Point(6, 130);
            listView5.BackColor = Color.White;
            listView6.Size = new Size((int)(767 * scale), (int)(483 * scale)); //new Size(767, 483);
            listView6.Location = new Point((int)(6 * scale), (int)(130 * scale)); //new Point(6, 130);
            listView6.BackColor = Color.White;
            listView7.Size = new Size((int)(767 * scale), (int)(483 * scale)); //new Size(767, 483);
            listView7.Location = new Point((int)(6 * scale), (int)(130 * scale)); //new Point(6, 130);
            listView7.BackColor = Color.White;
            listView8.Size = new Size((int)(767 * scale), (int)(483 * scale)); //new Size(767, 483);
            listView8.Location = new Point((int)(6 * scale), (int)(130 * scale)); //new Point(6, 130);
            listView8.BackColor = Color.White;
            listView9.Size = new Size((int)(767 * scale), (int)(483 * scale)); //new Size(767, 483);
            listView9.Location = new Point((int)(6 * scale), (int)(130 * scale)); //new Point(6, 130);
            listView9.BackColor = Color.White;
            listView10.Size = new Size((int)(767 * scale), (int)(483 * scale)); //new Size(767, 483);
            listView10.Location = new Point((int)(6 * scale), (int)(130 * scale)); //new Point(6, 130);
            listView10.BackColor = Color.White;
            listView11.Size = new Size((int)(767 * scale), (int)(483 * scale)); //new Size(767, 483);
            listView11.Location = new Point((int)(6 * scale), (int)(130 * scale)); //new Point(6, 130);
            listView11.BackColor = Color.White;
            panel3.Location = new Point((int)(176 * scale), (int)(140 * scale)); //new Point(176, 140);
            panel3.Size = new Size((int)(774 * scale), (int)(450 * scale)); //new Size(774, 450);
        }
        ...
        {
            滑块();
            滑标.Location = new Point(0, (int)(132 * scale)); //滑标.Location = new Point(0, 132);
        ...
        {
            滑块();
            滑标.Location = new Point(0, (int)(168 * scale)); //滑标.Location = new Point(0, 168);
            label4.BackColor = 背景;
        ...
        {
            滑块();
            滑标.Location = new Point(0, (int)(204 * scale)); //滑标.Location = new Point(0, 204);
            label5.BackColor = 背景;
        ...
        {
            滑块();
            滑标.Location = new Point(0, (int)(240 * scale)); //滑标.Location = new Point(0, 240);
            label6.BackColor = 背景;
        ...
        {
            滑块();
            滑标.Location = new Point(0, (int)(276 * scale)); //滑标.Location = new Point(0, 276);
            label7.BackColor = 背景;
        ...
        {
            滑块();
            滑标.Location = new Point(0, (int)(312 * scale)); //滑标.Location = new Point(0, 312);
            label8.BackColor = 背景;
        ...
        {
            滑块();
            滑标.Location = new Point(0, (int)(348 * scale)); //滑标.Location = new Point(0, 348);
            label9.BackColor = 背景;
        ...
        {
            滑块();
            滑标.Location = new Point(0, (int)(384 * scale)); //滑标.Location = new Point(0, 384);
        ...
        {
            滑块();
            滑标.Location = new Point(0, (int)(420 * scale)); //滑标.Location = new Point(0, 420);
        ...
        {
            滑块();
            滑标.Location = new Point(0, (int)(456 * scale));  //滑标.Location = new Point(0, 456);
        ...
        {
            滑块();
            滑标.Location = new Point(0, (int)(492 * scale)); //滑标.Location = new Point(0, 492);
        ...
        {
            滑块();
            滑标.Location = new Point(0, (int)(528 * scale)); //滑标.Location = new Point(0, 528);
        ...
        {
            滑块();
            滑标.Location = new Point(0, (int)(565 * scale)); //滑标.Location = new Point(0, 565);
        ...
        //    lines.Clear();
        //    listView1.Clear();
        //    Size Bigimagsize = new Size(48, 48);
        ...
        private void 选择夹1初始化()
        {
            lines.Clear();
            listView1.Clear();
            imageList1.Images.Clear(); // ← 加這行清空舊圖示

            imageList1.ImageSize = new Size(48, 48);
            listView1.LargeImageList = imageList1;

            string configPath = API.默认我的文档() + "\\Rmdict\\config1.ini";
            ...
            foreach (string fileText in lines)
            {
                ...
                {
                    icon = Icon.ExtractAssociatedIcon(fileText);
                }
                else if (Directory.Exists(fileText))
                {
                    SHFILEINFO shfi = new SHFILEINFO();
                    SHGetFileInfo(fileText, (uint)0x80, ref shfi, (uint)Marshal.SizeOf(shfi), (uint)(0x100 | 0x400));
                    icon = (Icon)Icon.FromHandle(shfi.hIcon).Clone();
                ...
                ListViewItem iw = new ListViewItem
                {
                    Text = Path.GetFileNameWithoutExtension(fileText),
                    Name = fileText,
                    ImageIndex = imageList1.Images.Count - 1
                };

                listView1.Items.Add(iw);
            }
        }
        ...
        private void 选择夹2初始化()
        {
            lines2.Clear();
            listView2.Clear();
            imageList2.Images.Clear(); // ← 加這行清空舊圖示

            imageList2.ImageSize = new Size(48, 48);
            listView2.LargeImageList = imageList2;

            string configPath = API.默认我的文档() + "\\Rmdict\\config2.ini";
            if (!File.Exists(configPath)) return;
            ...
            foreach (string fileText in lines2)
            {
                ...
                imageList2.Images.Add(icon.ToBitmap());

                ListViewItem iw = new ListViewItem
                {
                    Text = Path.GetFileNameWithoutExtension(fileText),
                    Name = fileText,
                    ImageIndex = imageList2.Images.Count - 1
                };

                listView2.Items.Add(iw);
            }
        }
        ...
        private void 选择夹3初始化()
        {
            lines3.Clear();
            listView3.Clear();
            imageList3.Images.Clear(); // ← 加這行清空舊圖示

            imageList3.ImageSize = new Size(48, 48);
            listView3.LargeImageList = imageList3;

            string configPath = API.默认我的文档() + "\\Rmdict\\config3.ini";
            if (!File.Exists(configPath)) return;
            ...
            foreach (string fileText in lines3)
            {
                ...
                imageList3.Images.Add(icon.ToBitmap());

                ListViewItem iw = new ListViewItem
                {
                    Text = Path.GetFileNameWithoutExtension(fileText),
                    Name = fileText,
                    ImageIndex = imageList3.Images.Count - 1
                };

                listView3.Items.Add(iw);
            }
        }
        ...
        private void 选择夹4初始化()
        {
            lines4.Clear();
            listView4.Clear();
            imageList4.Images.Clear(); // ← 加這行清空舊圖示

            imageList4.ImageSize = new Size(48, 48);
            listView4.LargeImageList = imageList4;

            string configPath = API.默认我的文档() + "\\Rmdict\\config4.ini";
            if (!File.Exists(configPath)) return;
            ...
            foreach (string fileText in lines4)
            {
                ...
                imageList4.Images.Add(icon.ToBitmap());

                ListViewItem iw = new ListViewItem
                {
                    Text = Path.GetFileNameWithoutExtension(fileText),
                    Name = fileText,
                    ImageIndex = imageList4.Images.Count - 1
                };

                listView4.Items.Add(iw);
            }
        }
        ...
        private void 选择夹5初始化()
        {
            lines5.Clear();
            listView5.Clear();
            imageList5.Images.Clear(); // ← 加這行清空舊圖示

            imageList5.ImageSize = new Size(48, 48);
            listView5.LargeImageList = imageList5;

            string configPath = API.默认我的文档() + "\\Rmdict\\config5.ini";
            if (!File.Exists(configPath)) return;
            ...
            foreach (string fileText in lines5)
            {
                ...
                imageList5.Images.Add(icon.ToBitmap());

                ListViewItem iw = new ListViewItem
                {
                    Text = Path.GetFileNameWithoutExtension(fileText),
                    Name = fileText,
                    ImageIndex = imageList5.Images.Count - 1
                };

                listView5.Items.Add(iw);
            }
        }
        ...
        private void 选择夹6初始化()
        {
            lines6.Clear();
            listView6.Clear();
            imageList6.Images.Clear(); // ← 加這行清空舊圖示

            imageList6.ImageSize = new Size(48, 48);
            listView6.LargeImageList = imageList6;

            string configPath = API.默认我的文档() + "\\Rmdict\\config6.ini";
            if (!File.Exists(configPath)) return;
            ...
            foreach (string fileText in lines6)
            {
                ...
                imageList6.Images.Add(icon.ToBitmap());

                ListViewItem iw = new ListViewItem
                {
                    Text = Path.GetFileNameWithoutExtension(fileText),
                    Name = fileText,
                    ImageIndex = imageList6.Images.Count - 1
                };

                listView6.Items.Add(iw);
            }
        }
        ...
        private void 选择夹7初始化()
        {
            lines7.Clear();
            listView7.Clear();
            imageList7.Images.Clear(); // ← 加這行清空舊圖示

            imageList7.ImageSize = new Size(48, 48);
            listView7.LargeImageList = imageList7;

            string configPath = API.默认我的文档() + "\\Rmdict\\config7.ini";
            if (!File.Exists(configPath)) return;
            ...
            foreach (string fileText in lines7)
            {
                ...
                imageList7.Images.Add(icon.ToBitmap());

                ListViewItem iw = new ListViewItem
                {
                    Text = Path.GetFileNameWithoutExtension(fileText),
                    Name = fileText,
                    ImageIndex = imageList7.Images.Count - 1
                };

                listView7.Items.Add(iw);
            }
        }
        ...
        private void 选择夹8初始化()
        {
            lines8.Clear();
            listView8.Clear();
            imageList8.Images.Clear(); // ← 加這行清空舊圖示

            imageList8.ImageSize = new Size(48, 48);
            listView8.LargeImageList = imageList8;

            string configPath = API.默认我的文档() + "\\Rmdict\\config8.ini";
            if (!File.Exists(configPath)) return;
            ...
            foreach (string fileText in lines8)
            {
                ...
                imageList8.Images.Add(icon.ToBitmap());

                ListViewItem iw = new ListViewItem
                {
                    Text = Path.GetFileNameWithoutExtension(fileText),
                    Name = fileText,
                    ImageIndex = imageList8.Images.Count - 1
                };

                listView8.Items.Add(iw);
            }
        }
        ...
        private void 选择夹9初始化()
        {
            lines9.Clear();
            listView9.Clear();
            imageList9.Images.Clear(); // ← 加這行清空舊圖示

            imageList9.ImageSize = new Size(48, 48);
            listView9.LargeImageList = imageList9;

            string configPath = API.默认我的文档() + "\\Rmdict\\config9.ini";
            if (!File.Exists(configPath)) return;
            ...
            foreach (string fileText in lines9)
            {
                ...
                imageList9.Images.Add(icon.ToBitmap());

                ListViewItem iw = new ListViewItem
                {
                    Text = Path.GetFileNameWithoutExtension(fileText),
                    Name = fileText,
                    ImageIndex = imageList9.Images.Count - 1
                };

                listView9.Items.Add(iw);
            }
        }
        ...
        private void 选择夹10初始化()
        {
            lines10.Clear();
            listView10.Clear();
            imageList10.Images.Clear(); // ← 加這行清空舊圖示

            imageList10.ImageSize = new Size(48, 48);
            listView10.LargeImageList = imageList10;

            string configPath = API.默认我的文档() + "\\Rmdict\\config10.ini";
            if (!File.Exists(configPath)) return;
            ...
            foreach (string fileText in lines10)
            {
                ...
                imageList10.Images.Add(icon.ToBitmap());

                ListViewItem iw = new ListViewItem
                {
                    Text = Path.GetFileNameWithoutExtension(fileText),
                    Name = fileText,
                    ImageIndex = imageList10.Images.Count - 1
                };

                listView10.Items.Add(iw);
            }
        }
        private void 选择夹11初始化()
        {
            lines11.Clear();
            listView11.Clear();
            imageList11.Images.Clear(); // ← 加這行清空舊圖示

            imageList11.ImageSize = new Size(48, 48);
            listView11.LargeImageList = imageList11;

            string configPath = API.默认我的文档() + "\\Rmdict\\config11.ini";
            if (!File.Exists(configPath)) return;
            ...
            foreach (string fileText in lines11)
            {
                ...
                imageList11.Images.Add(icon.ToBitmap());

                ListViewItem iw = new ListViewItem
                {
                    Text = Path.GetFileNameWithoutExtension(fileText),
                    Name = fileText,
                    ImageIndex = imageList11.Images.Count - 1
                };

                listView11.Items.Add(iw);
            }
        }
        ...
        private void listView1_DragDrop(object sender, DragEventArgs e)
        {
            ...
            foreach (string fileText in droppedFiles)
            {
                if (lines.Contains(fileText)) continue; // 避免重複加入
                ...
                {
                    MessageBox.Show($"不支援的項目: {fileText}");
                    continue;
                }
        ...
        //    foreach (string fileText in files)
        //    {
        //        try
        //        {
        //            if (!File.Exists(fileText) && !Directory.Exists(fileText))
        //            {
        //                MessageBox.Show($"不支持的檔案類型：{fileText}");
        //                continue;
        //            }
        ...
        //            {
        //                SHFILEINFO shfi = new SHFILEINFO();
        //                SHGetFileInfo(fileText, 0x80, ref shfi, (uint)Marshal.SizeOf(shfi), 0x100 | 0x400);
        //                icon = (Icon)Icon.FromHandle(shfi.hIcon).Clone();
        //                DestroyIcon(shfi.hIcon);
        //            }
        ...
        //            using (StreamWriter sw = new StreamWriter(API.默认我的文档() + "\\Rmdict\\config2.ini", true, Encoding.UTF8))
        //            {
        //                sw.WriteLine(fileText);
        //            }
        //        }
        //        catch (Exception ex)
        //        {
        //            MessageBox.Show($"處理檔案失敗：{fileText}\n錯誤：{ex.Message}");
        //        }
        //    }
        //}
        ...
        private void listView2_DragDrop(object sender, DragEventArgs e)
        {
            ...
            foreach (string fileText in droppedFiles)
            {
                if (lines2.Contains(fileText)) continue; // 避免重複加入
        ...
        private void listView3_DragDrop(object sender, DragEventArgs e)
        {
            ...
            foreach (string fileText in droppedFiles)
            {
                if (lines3.Contains(fileText)) continue; // 避免重複加入
        ...
        private void listView4_DragDrop(object sender, DragEventArgs e)
        {
            ...
            foreach (string fileText in droppedFiles)
            {
                if (lines4.Contains(fileText)) continue; // 避免重複加入
        ...
        private void listView5_DragDrop(object sender, DragEventArgs e)
        {
            ...
            foreach (string fileText in droppedFiles)
            {
                if (lines5.Contains(fileText)) continue; // 避免重複加入
        ...
        private void listView6_DragDrop(object sender, DragEventArgs e)
        {
            ...
            foreach (string fileText in droppedFiles)
            {
                if (lines6.Contains(fileText)) continue; // 避免重複加入
        ...
        private void listView7_DragDrop(object sender, DragEventArgs e)
        {
            ...
            foreach (string fileText in droppedFiles)
            {
                if (lines7.Contains(fileText)) continue; // 避免重複加入
        ...
        private void listView8_DragDrop(object sender, DragEventArgs e)
        {
            ...
            foreach (string fileText in droppedFiles)
            {
                if (lines8.Contains(fileText)) continue; // 避免重複加入
        ...
        private void listView9_DragDrop(object sender, DragEventArgs e)
        {
            ...
            foreach (string fileText in droppedFiles)
            {
                if (lines9.Contains(fileText)) continue; // 避免重複加入
        ...
        private void listView10_DragDrop(object sender, DragEventArgs e)
        {
            ...
            foreach (string fileText in droppedFiles)
            {
                if (lines10.Contains(fileText)) continue; // 避免重複加入
        ...
        private void listView11_DragDrop(object sender, DragEventArgs e)
        {
            ...
            foreach (string fileText in droppedFiles)
            {
                if (lines11.Contains(fileText)) continue; // 避免重複加入
        ...
        private void 删除ToolStripMenuItem_Click_1(object sender, EventArgs e)
        {
            ...
            if (listView1.SelectedItems.Count > 0)
            {
                ...
                string selectedPath = listView1.Items[index].Name;

                lines.Remove(selectedPath);
            ...
            else if (listView2.SelectedItems.Count > 0)
            {
                ...
                string selectedPath = listView2.Items[index].Name;

                lines2.Remove(selectedPath);
            ...
            else if (listView3.SelectedItems.Count > 0)
            {
                ...
                string selectedPath = listView3.Items[index].Name;

                lines3.Remove(selectedPath);
            ...
            else if (listView4.SelectedItems.Count > 0)
            {
                ...
                string selectedPath = listView4.Items[index].Name;

                lines4.Remove(selectedPath);
            ...
            else if (listView5.SelectedItems.Count > 0)
            {
                ...
                string selectedPath = listView5.Items[index].Name;

                lines5.Remove(selectedPath);
                listView5.Items.RemoveAt(index);
            ...
            else if (listView6.SelectedItems.Count > 0)
            {
                ...
                string selectedPath = listView6.Items[index].Name;

                lines6.Remove(selectedPath);
            ...
            else if (listView7.SelectedItems.Count > 0)
            {
                int index = listView7.SelectedItems[0].Index;
                string selectedPath = listView7.Items[index].Name;

                lines7.Remove(selectedPath);
                listView7.Items.RemoveAt(index);

                File.WriteAllLines(API.默认我的文档() + "\\Rmdict\\config7.ini", lines7, Encoding.UTF8);
            }
            else if (listView8.SelectedItems.Count > 0)
            {
                int index = listView8.SelectedItems[0].Index;
                string selectedPath = listView8.Items[index].Name;

                lines8.Remove(selectedPath);
                listView8.Items.RemoveAt(index);

                File.WriteAllLines(API.默认我的文档() + "\\Rmdict\\config8.ini", lines8, Encoding.UTF8);
            }
            else if (listView9.SelectedItems.Count > 0)
            {
                int index = listView9.SelectedItems[0].Index;
                string selectedPath = listView9.Items[index].Name;

                lines9.Remove(selectedPath);
                listView9.Items.RemoveAt(index);

                File.WriteAllLines(API.默认我的文档() + "\\Rmdict\\config9.ini", lines9, Encoding.UTF8);
            }
            else if (listView10.SelectedItems.Count > 0)
            {
                int index = listView10.SelectedItems[0].Index;
                string selectedPath = listView10.Items[index].Name;

                lines10.Remove(selectedPath);
                listView10.Items.RemoveAt(index);

                File.WriteAllLines(API.默认我的文档() + "\\Rmdict\\config10.ini", lines10, Encoding.UTF8);
            }
            else if (listView11.SelectedItems.Count > 0)
            {
                int index = listView11.SelectedItems[0].Index;
                string selectedPath = listView11.Items[index].Name;

                lines11.Remove(selectedPath);
                listView11.Items.RemoveAt(index);
        ...
        private void CPUZHANYONG()
        {
            ...
            label28.Text = "設備名稱: " + Environment.MachineName;
            label18.Text = "用戶: " + Environment.UserName;//获取当前用户
            label20.Text = "語言: " + System.Globalization.CultureInfo.InstalledUICulture.Name;
